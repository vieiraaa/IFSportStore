            ...
            <div class="col-8">
              <form method="post" action="{{ route('fornecedores_salvar') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" value="{{ $fornecedor->nome }}" aria-describedby="emailHelp">
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cnpj" name="cnpj" value="{{ $fornecedor->cnpj }}">
                                ...
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" id="cep" name="cep" aria-describedby="emailHelp" value="{{ $fornecedor->cep }}">
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Cidade" value="{{ $fornecedor->cidade }}">
                    ...
                    <button type="submit" class="btn btn-warning" value="Enviar">Alterar Fornecedor</button>
                  </form>
            </div>
